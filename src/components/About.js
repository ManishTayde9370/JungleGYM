    ...
    return (
        <div className="container mt-5">
            ...
            <section className="service">
             <center><h1 className="heading">Our <span>Team</span></h1></center> 
                    ...
                    <div className="review">
                        ...
                        <div className="review-info">
                            ...
                            <div className="review-details" data-aos="fade-down">
                                ...
                                <div>
                                    Jungle Gym is not just a gym; it's a lifestyle. The facility is top-notch, and the trainers are top-level...
                                </div>
                            </div>
                        </div>
                    </div>
